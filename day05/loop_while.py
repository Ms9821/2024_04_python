...
# 문자에게 언어를 고르세요(1.python 2.java 3.c++)
#1.python
#2.java
#3.c++
#4.프로그램 종료
#그 외는 숫자를 잘못 입력하였습니다.
# while True:
#    num = input("언어를 고르세요(1.python 2.java 3.c++):")
#    if num == 1:
#        print("python")
#    elif num == 2:
#        print("java")
...
# 계산기 프로그램
# 유저에게 1.더하기 2.빼기 3.곱하기 4.제곱 5.나누기(몫)
# 그 외 번호는 번호 입력 오류-> 다시 묻기!
# 1번 -> 두 정수를 입력하고 더한 결과값이 나옴
# 2번 -> 두 젇수를 입력하고 뺀 결과값이 나옴
